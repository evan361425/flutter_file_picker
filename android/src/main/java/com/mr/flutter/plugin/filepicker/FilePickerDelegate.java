...
public class FilePickerDelegate implements PluginRegistry.ActivityResultListener, PluginRegistry.RequestPermissionsResultListener {
    ...
    private void startFileExplorer() {
        ...
        if (type.equals("dir")) {
            ...
            if (type.equals("image/*")) {
                ...
                Log.d(TAG, "First extra extesion " + extraExtensions[0]);
                intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
                intent.putExtra(Intent.EXTRA_MIME_TYPES, extraExtensions);
            } else {
                Log.d(TAG, "Extra extesion is null");
    ...
    @SuppressWarnings("deprecation")
    public void startFileExplorer(final String type, final boolean isMultipleSelection, final boolean withData, final String[] allowedExtensions, final String[] extraExtensions, final MethodChannel.Result result) {
